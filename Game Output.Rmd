---
title: "Appendix"
author: "Game Predictions"
output:
  pdf_document: default
  html_document: default
---
### *Denote*: $P_j$ is any player that is not $P_i$.
...
game_simulations <- function(num_simulations, best_resp="Yes", pareto="Yes", NE="Yes"){
  ...
  footnote(number = c("Sj = Range of values that Player j can choose.", "Vj(Sj, Si) = Range of payoffs for Player j, for their possible strategies.")) %>%
  row_spec(0, bold = T)%>%
